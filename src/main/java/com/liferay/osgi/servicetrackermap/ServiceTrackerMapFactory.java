...
import com.liferay.osgi.servicetrackermap.internal.DefaultServiceTrackerCustomizer;
import com.liferay.osgi.servicetrackermap.internal.MultiValueServiceTrackerBucketFactory;
import com.liferay.osgi.servicetrackermap.internal.ServiceTrackerMapImpl;
import com.liferay.osgi.servicetrackermap.internal.SingleValueServiceTrackerBucketFactory;
...
public class ServiceTrackerMapFactory {
    public static <S> ServiceTrackerMap<String, List<S>> multiValueMap(
        ...
        return new ServiceTrackerMapImpl<>(
            bundleContext, clazz,"(" + propertyKey + "=*)", new PropertyServiceReferenceMapper<String, S>(propertyKey),
            new DefaultServiceTrackerCustomizer<S>(bundleContext), new MultiValueServiceTrackerBucketFactory<S, S>());
    }
    ...
    public static <K, S> ServiceTrackerMap<K, List<S>> multiValueMap(
            BundleContext bundleContext, Class<S> clazz, String filterString,
            ServiceReferenceMapper<K, S> serviceReferenceMapper, Comparator<ServiceReference<S>> comparator)
        throws InvalidSyntaxException {
    ...
    public static <K, SR, S> ServiceTrackerMap<K, List<S>> multiValueMap(
        ...
        return new ServiceTrackerMapImpl<>(
            bundleContext, clazz, filterString, serviceReferenceMapper, serviceTrackerCustomizer,
    ...
    public static <K, SR, S> ServiceTrackerMap<K, List<S>> multiValueMap(
            BundleContext bundleContext, Class<SR> clazz, String filterString,
            ServiceReferenceMapper<K, SR> serviceReferenceMapper,
            ServiceTrackerCustomizer<SR, S> serviceTrackerCustomizer, Comparator<ServiceReference<SR>> comparator)
        throws InvalidSyntaxException {
    ...
    public static <SR, S> ServiceTrackerMap<String, List<S>> multiValueMap(
        ...
        return new ServiceTrackerMapImpl<>(
            ...
            new PropertyServiceReferenceMapper<String, SR>(propertyKey), serviceTrackerCustomizer,
            new MultiValueServiceTrackerBucketFactory<SR, S>());
    }
    ...
    public static <S> ServiceTrackerMap<String, S> singleValueMap(
        ...
        return new ServiceTrackerMapImpl<>(
            bundleContext, clazz, "(" + propertyKey + "=*)", new PropertyServiceReferenceMapper<String, S>(propertyKey),
            new DefaultServiceTrackerCustomizer<S>(bundleContext), new SingleValueServiceTrackerBucketFactory<S, S>());
    }
    ...
    public static class PropertyServiceReferenceComparator <T>
        ...
        public int compare(ServiceReference<T> serviceReference1, ServiceReference<T> serviceReference2) {
            ...
            Comparable<Object> propertyValueComparable1 = (Comparable<Object>)propertyValue1;
    ...
    public static class PropertyServiceReferenceMapper<T, S> implements ServiceReferenceMapper<T, S> {
