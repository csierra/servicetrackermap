...
public class MultiValueServiceTrackerBucketFactory<SR, TS> implements ServiceTrackerBucketFactory<SR, TS, List<TS>> {
	...
	private class ListServiceTrackerBucket implements ServiceTrackerBucket<SR, TS, List<TS>> {
		...
		protected void rebuild() {
			...
			for (
				ServiceReferenceServiceTuple<SR, TS> serviceReferenceServiceTuple : _serviceReferenceServiceTuples) {
		...
		private ListServiceTrackerBucket() {
			ServiceReferenceServiceTupleComparator<SR> serviceReferenceServiceTupleComparator =
                new ServiceReferenceServiceTupleComparator<>(_comparator);

			_serviceReferenceServiceTuples = new TreeSet<>(serviceReferenceServiceTupleComparator);
		}

		private Set<ServiceReferenceServiceTuple<SR, TS>> _serviceReferenceServiceTuples;
