...
public class SingleValueServiceTrackerBucketFactory<SR, TS> implements ServiceTrackerBucketFactory<SR, TS, TS> {
	...
	private class SingleBucket implements ServiceTrackerBucket<SR, TS, TS> {
		...
		public SingleBucket() {
			...
			_serviceReferences = new PriorityQueue<>(1, serviceReferenceServiceTupleComparator);
		}
		...
		private TS _service;
		private PriorityQueue<ServiceReferenceServiceTuple<SR, TS>> _serviceReferences;
