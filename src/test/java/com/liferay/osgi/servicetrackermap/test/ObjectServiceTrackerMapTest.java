 ...
 */
@BndFile("target/test-classes/bnd.bnd")
...
public class ObjectServiceTrackerMapTest {
	...
	@Test
	public void testGetServiceWithCustomComparator() throws InvalidSyntaxException {
		ServiceTrackerMap<String, TrackedOne> serviceTrackerMap =
	...
	@Test
	public void testGetServiceWithCustomResolver() throws InvalidSyntaxException {
		ServiceTrackerMap<String, TrackedOne> serviceTrackerMap =
	...
	@Test
	public void testGetServiceWithServiceCustomizer() throws InvalidSyntaxException {
	...
	@Test
	public void testGetServiceWithServiceCustomizerAndServiceReferenceMapper() throws InvalidSyntaxException {
		ServiceTrackerMap<String, TrackedTwo> serviceTrackerMap =
			ServiceTrackerMapFactory.singleValueMap(
				_bundleContext, TrackedOne.class, ("(target=*)"),
				new ServiceReferenceMapper<String, TrackedOne>() {
				...
				new ServiceTrackerCustomizer<TrackedOne, TrackedTwo>() {
					...
					@Override
					public void modifiedService(ServiceReference<TrackedOne> serviceReference, TrackedTwo service) {

						removedService(serviceReference, service);
					}

					@Override
					public void removedService(ServiceReference<TrackedOne> serviceReference, TrackedTwo service) {
	...
	@Test
	public void testUnkeyedServiceReferencesBalanceRefCount() throws InvalidSyntaxException {
		...
		ServiceTrackerMap<TrackedOne, TrackedOne> serviceTrackerMap =
			ServiceTrackerMapFactory.singleValueMap(
				...
				new ServiceReferenceMapper<TrackedOne, TrackedOne>() {
					...
					@Override
					public void map(ServiceReference<TrackedOne> serviceReference, Emitter<TrackedOne> emitter) {
					}
